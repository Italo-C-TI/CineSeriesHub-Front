...
export const MovieCard = ({movie}: MoviesCardParamsInterface) => {
    return (
      <article className="flex items-start space-x-6 p-6">
        <img src={movie.poster_path} alt="" width="60" height="88" className="flex-none rounded-md bg-slate-100" />
        <div className="min-w-0 relative flex-auto">
          ...
          <dl className="mt-2 flex flex-wrap text-sm leading-6 font-medium">
            ...
            <div>
              ...
              <dd className="px-1.5 ring-1 ring-slate-200 rounded">{movie.title}</dd>
            </div>
            <div className="ml-2">
            ...
            <div className="flex-none w-full mt-2 font-normal">
              ...
              <dd className="text-slate-400">{movie.vote_average}</dd>
            </div>
          </dl>
        </div>
      </article>
